...
public class ExcursionDTO extends ExcursionCreateDTO {
     ...
     */
    public ExcursionDTO(@NotNull String description, @NotNull String destination, @NotNull BigDecimal price, @NotNull LocalDate excursionDate, @NotNull Duration excursionDuration, @NotNull TripDTO trip, Long id) {
